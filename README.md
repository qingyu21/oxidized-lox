...
- variables, assignment, block scope, `if`, logical `and` / `or`, and `?:`
...
- The language implementation is still a subset of full Lox and does not yet
  support loops, functions, or classes.

## Roadmap

Near-term goals:

- add the next statement and control-flow features from the book
